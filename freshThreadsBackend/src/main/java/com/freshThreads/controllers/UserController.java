...
//	@PostMapping("/signin")
//	public ResponseEntity<?> authUser(@RequestBody @Valid AuthRequest dto) {
//		try {
//			UserResDTO respDTO = userService.authamticate(dto);
...
//	@PostMapping("/signup")
//	public ResponseEntity<?> authUser(@RequestBody @Valid UserAuthDTO dto) {
//		try {
//			UserAuthDTO respDTO = userService.userSignUp(dto);
//			return ResponseEntity.ok(respDTO);
//
//		} catch (Exception e) {
//			System.out.println(e);
...
//	}
	...
	// => authentication successful ! //3. In case of successful auth, //create
